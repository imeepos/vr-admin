import { O as OrthographicCamera, B as BufferGeometry, F as Float32BufferAttribute, C as Color, W as WebGLRenderTarget, R as RGBAFormat, H as HalfFloatType, N as NearestFilter, L as LinearFilter, D as DepthTexture, U as UnsignedInt248Type, a as UnsignedIntType, b as DepthStencilFormat, c as DepthFormat, M as Matrix4, d as DataTexture, S as ShaderMaterial, e as NoColorSpace, f as RepeatWrapping, V as Vector2, g as RedFormat, h as FloatType, i as Vector3, P as Pass$1, j as Mesh, k as Sphere, l as BufferAttribute, m as REVISION } from "./needle-engine-DXCNciSc.js";
...
class $e4ca8dcb0218f846$var$FullScreenTriangleGeometry extends BufferGeometry {
...
const $e4ca8dcb0218f846$var$_camera = /* @__PURE__ */ new OrthographicCamera();
...
const $ff9437d9c7577f11$var$version = /* @__PURE__ */ (() => parseInt(REVISION.replace(/\D+/g, "")))();
const $ff9437d9c7577f11$export$156f6a58f569aa09 = $ff9437d9c7577f11$var$version >= 162 ? class extends WebGLRenderTarget {
...
class $87431ee93b037844$export$2489f9981ab0fa82 extends Pass$1 {
  /**
   * 
  ...
  constructor(scene, camera, width = 512, height = 512) {
    ...
    this.bluenoise = new DataTexture($06269ad78f3c5fdf$export$2e2bcd8739ae039, 128, 128);
...
class $05f6997e4b65da14$export$2d57db20b5eb5e0a extends Pass {
  ...
  configureHalfResTargets() {
    ...
    if (this.configuration.halfRes) {
      ...
      this.depthDownsampleTarget.textures[1].depthBuffer = false;
      const e = {
        ...$26aca173e0984d99$export$1efdf491687cd442
      };
      ...
      this.depthDownsampleQuad = new $e4ca8dcb0218f846$export$dcd670d73db751f5(new ShaderMaterial(e));
    } else {
      if (this.depthDownsampleTarget) {
        this.depthDownsampleTarget.dispose();
        this.depthDownsampleTarget = null;
...
//# sourceMappingURL=N8AO-Cslw5z7J.js.map
