  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:flex sm:items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 sm:mt-0 sm:ml-16 sm:flex-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard/models/create", className: "btn btn-primary px-2 py-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flow-root", children: models.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard/models/create", className: "btn btn-primary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$3, { className: "w-4 h-4 mr-2 px-2 py-1" }),
          "创建第一个模型"
        ] })
...
function ModelPreview({ modelUrl, className = "" }) {
  const needleEngineRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    if (isServer() || !modelUrl) return;
    let mounted = true;
    __vitePreload(() => import("./needle-engine-DXCNciSc.js").then((n2) => n2.a8), true ? [] : void 0).then((needle) => {
      if (!mounted) return;
      needle.onStart((ctx) => {
        if (ctx.menu) {
  ...
  if (isServer() || !modelUrl) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-gray-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm", children: modelUrl ? "加载中..." : "暂无模型预览" })
        ] })
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `relative bg-gray-900 rounded-lg overflow-hidden ${className}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "needle-engine",
    {
      ref: needleEngineRef,
      src: modelUrl,
...
function CreateModelPage() {
  ...
  const [backgroundImageFile, setBackgroundImageFile] = reactExports.useState(
    null
  );
  const [backgroundVideoFile, setBackgroundVideoFile] = reactExports.useState(
    null
  );
    ...
    isLoadingModel ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-primary-600" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-content", children: [
          ...
          previewUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setShowPreview(!showPreview),
              className: "btn btn-secondary w-full",
              children: showPreview ? "隐藏预览" : "显示预览"
            }
          ) })
        ] })
      ] }),
      showPreview && previewUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "card-title", children: "3D 模型预览" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "card-description", children: "实时预览您的 3D 模型效果。" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ModelPreview,
          {
...
//# sourceMappingURL=index-Doj8EsS-.js.map
